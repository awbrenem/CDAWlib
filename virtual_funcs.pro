...
;   none
;
; History: Written by Ron Yurow 03/19, based on alternate_view
;-

function reorder, buf, org_names, index=index
...
; WARNING if /NODATASTRUCT keyword not set an error will occur here
        IF  (tagindex ('HANDLE', tagnames1) ge 0) THEN BEGIN
            ...
            HANDLE_VALUE, buf.(prime_ind).handle, prime_data

            ; Find out about the dimensions.
            dim = SIZE (prime_data, /DIMENSIONS)
             
            ; And number of dimensions.
            ndim = N_ELEMENTS (dim)

            ; Check for vector data.  Anything else won't work.  
            IF  ndim ne 1 THEN BEGIN
                print, "WARNING=Reorder failed."
                print, "WARNING=Data to be reordered must be vector or based on the sequence of " + $
                               "elemens in a sorted vector."
            ...
            IF  (second ne "") THEN BEGIN
                ...
                ; Get the secondary data.  This data will also be sorted in ascending order.
                HANDLE_VALUE, buf.(second_ind).handle, second_data

                ; Find out about the dimensions.
                dim = SIZE (second_data, /DIMENSIONS)
            ...
            ENDIF ELSE BEGIN
                ...
                IF  (second ne "") THEN BEGIN
                    ...
                    ; Determine which array dimension corresponds to second variable.
                    second_dim = WHERE (N_ELEMENTS (second_order) eq dim, cnt)
                    ...
                    ; The time dimension will be the only one that is left.
                    time_dim = WHERE (found eq 1)
                    ...
                    ; and COMPONENT_2 (secondary) will be second.
                    ...
                    depend_data = depend_data [prime_order, second_order, *]
