;$Author: kovalick $ 
;$Date: 2018/12/21 17:03:47 $
;$Header: /home/cdaweb/dev/control/RCS/plot_plasmagram.pro,v 1.140 2018/12/21 17:03:47 kovalick Exp tkovalic $
;$Locker: tkovalic $
;$Revision: 1.140 $
;+
...
;a little differently than in the past...
  ...
  if (fc gt 0) then begin
    ...
    print,'WARNING=No data found - all data is fill or out of range!!' & return, -1
    wmin=1 & wmax = 1.1
  endelse     
...
if COLORBAR then begin 
  ...
  if (label_vars[0] ne 'none') then begin ; there are labels, set margins to allow 
    ...
    if (n_elements(label_vars) eq 1) then begin ; don't need as much space
      !y.margin[0] = 8 ;TJK make room for xaxis scales and lables
      !y.margin[1] = 3 ;TJK make room for xaxis scales and top title
    endif
  endif
