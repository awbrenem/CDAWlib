...
FUNCTION AUDIO_WAV, astruct, vname, RANGE=range, GIF=gif, REDUCE_ALL=reduce, $
...
ENDIF ELSE BEGIN
    ...
    IF  found_display && (N_ELEMENTS (dsp) ge 2) THEN BEGIN
